                  ...
                  <Routes>
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<PageLoader />}>
                          {React.createElement(
                            lazy(() => import('./pages/Auth/User/UserSignup')),
                          )}
                        </Suspense>
                      }
                    />
                      ...
                      element={
                        <Suspense fallback={<PageLoader />}>
                          {React.createElement(
                            lazy(
                              () =>
                                import('./pages/Users/Client/HackathonDetail'),
                            ),
                          )}
                        </Suspense>
                      }
                        ...
                        <Suspense fallback={<PageLoader />}>
                          {React.createElement(
                            lazy(
                              () =>
                                import(
                                  './pages/History/Admin/AdminTransactionHistory'
                                ),
                            ),
                          )}
                        </Suspense>
                        ...
                        <Suspense fallback={<PageLoader />}>
                          {React.createElement(
                            lazy(
                              () =>
                                import(
                                  './pages/History/Users/HackathonHistory'
                                ),
                            ),
                          )}
                        </Suspense>
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<PageLoader />}>
                          {React.createElement(
                            lazy(
                              () => import('./pages/Event/Admin/AdminEvents'),
                            ),
                          )}
                        </Suspense>
                      }
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<PageLoader />}>
                          {React.createElement(
                            lazy(
                              () => import('./pages/Users/Admin/AdminInviteUsers'),
                            ),
                          )}
                        </Suspense>
                      }
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<PageLoader />}>
                          {React.createElement(
                            lazy(() => import('./pages/Auth/ProfileSettings')),
                          )}
                        </Suspense>
                      }
                    />
                        ...
                        <Suspense fallback={<PageLoader />}>
                          {React.createElement(
                            lazy(
                              () =>
                                import(
                                  './pages/History/Client/AllTransactions'
                                ),
                            ),
                          )}
                        </Suspense>
                    ...
                    <Route
                      ...
                      element={
                        <Suspense fallback={<PageLoader />}>
                          {React.createElement(
                            lazy(() => import('./pages/Auth/RecoverPassword')),
                          )}
                        </Suspense>
                      }
                    />
                      ...
                      element={
                        <Suspense fallback={<PageLoader />}>
                          {React.createElement(
                            lazy(
                              () =>
                                import('./pages/Users/Client/CreateHackathon'),
                            ),
                          )}
                        </Suspense>
                      }
                      ...
                      element={
                        <Suspense fallback={<PageLoader />}>
                          {React.createElement(
                            lazy(
                              () =>
                                import('./pages/Event/Admin/AdminEventDetail'),
                            ),
                          )}
                        </Suspense>
                      }
