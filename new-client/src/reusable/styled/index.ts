...
export const PendingStatusIcon = styled(StatusIcon)`
  background-color: #f7e0a4;
...
export const PublishedStatusIcon = styled(StatusIcon)`
  background-color: #c4e4e2;

  &::before {
    background-color: #2ca688;
  }
`;

export const ReviewingStatusIcon = styled(StatusIcon)`
  background-color: #d1eaff;
...
export const RejectedStatusIcon = styled(StatusIcon)`
  background-color: #fad2d0;
...
export const EndedStatusIcon = styled(StatusIcon)`
  background-color: #ffcccc;
