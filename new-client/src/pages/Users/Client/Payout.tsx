...
const Payout = () => {
  ...
  const { HMTokenAbi, getTokenInfo, walletClient, publicClient, getTokenRate } =
                                ...
                                (props: any, index: number) => {
                                  return (
                                    <Tr key={index}>
                                      ...
                                      <Td>
                                        {utcFormat(hackathon?.createdAt).format(
                                      ...
                                      <Td>
                                        <Flex flexDirection={'row'}>
                                          ...
                                          >
                                            ...
                                            ...
                                            {props.userWalletAddress.substring(
                                              props.userWalletAddress.length -
                                                3,
                                            )}
                                          </Text>
                                          <Tooltip
                                      ...
                                      {equalDistribution === 'no' ? (
                                        <Td>
                                          <Text fontWeight={'bold'}>
                                            {Number(userRewards[index]).toFixed(
                                              1,
                                            )}{' '}
                                            {
                                          ...
                                          <Button
                                            ...
                                            isDisabled={
                                              (hackathonSlice?.clientHackInfo?.winners.find(
                                                ...
                                                ? true
                                                : false) || !tokenInfo?.decimals
                                            }
                                            isLoading={
                                              userInPaying === props.user._id &&
                                              isPaying
                                            }
                                            onClick={() =>
                                              payoutUser(
